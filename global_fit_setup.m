...
%%
options.t2_array = [PEGDA_2d_crop.t2]/1000; %units of ps! 
...
options.pnames = {'Delta1 (cm-1)','tau1 (ps)','T2 (ps)','anh (cm-1)','phi (deg)','mu12_2','w0 (cm-1)','k1','k2','k3'};
...
w1 = PEGDA_2d_crop.w1;  %set as open range or crop to match data being fit
w3 = PEGDA_2d_crop.w3; %same as above
...
p0 = [Delta1_cm tau1 T2 anh_cm phi_deg mu12_2 mean_w_0 k1 k2 k3]; %[delta1_cm delta2_cm delta3_cm delta4_cm tau1_ps tau2_ps tau3_ps anh_cm]
...
ub = [5 500  15  30  40  2.5  2339    1      1      1];
lb = [0  10  0.1  20 -40 1.4 2337 0.0001 0.0001 0.0001];
