...
%cd('/home/sgrlab/Documents/CJK/PEGDA_HGS/') %LINUX MACHINE (for CJ's data)
...
T2 = 7.6; % dephasing time (1/value scales with antidiagonal width)
mu12_2 = 1.51; %intensity of dipole for 1-2 transition (can be removed and left at default value)
phi_deg = 1.71; %phase contributions
